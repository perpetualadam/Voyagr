    ...
    function redrawNavigationVehicleMarker(reason) {
        ...
        try {
            ...
            var redraw = SG.buildNavigationVehicleMarkerRedrawPlan({
                ...
                prevSnapBlendWeightState: rt().getSnapBlendWeightState(),
                smoothDisplayLat: rt().getSmoothDisplayLat(),
                smoothDisplayLon: rt().getSmoothDisplayLon(),
                useSmoothCoordsOnly: rt().getSmoothDisplayLat() != null && rt().getSmoothDisplayLon() != null,
                speedMph: speed,
                speed: speed,
